...
module.directive('dashboardSettingSyncApps', ["$templateCache", "$log", "$http", "ImpacMainSvc", "ImpacRoutes", function($templateCache, $log, $http, ImpacMainSvc, ImpacRoutes) {
  return {
    restrict: 'A',
    scope: {},
    link: function(scope, element, attrs) {
