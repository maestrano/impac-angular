...
angular.module('impac.components.common',
  [
    ...
    'impac.components.common.customers-list',
  ]
);
/*
** SERVICES
...
$templateCache.put("widgets/sales-offer-performance.tmpl.html","<div widget-sales-offer-performance>\n\n  <div ng-show=\"widget.isEditMode\" class=\"edit\">\n    <h4 translate>impac.widget.accounting_values.turnover.settings.title</h4>\n\n    <div setting-offers parent-widget=\"widget\" class=\"part\" deferred=\"::offersDeferred\" />\n    <div setting-last-time-period parent-widget=\"widget\" class=\"part\" deferred=\"::timePeriodDeferred\" hist-params=\"histParams\" />\n\n    <div class=\"bottom-buttons\" align=\"right\">\n      <button class=\"btn btn-default\" ng-click=\"initSettings()\" translate>impac.widget.accounting_values.turnover.cancel</button>\n      <button class=\"btn btn-warning\" ng-click=\"updateSettings()\" translate>impac.widget.accounting_values.turnover.save</button>\n    </div>\n  </div>\n\n  <div ng-hide=\"widget.isEditMode\">\n    <div>\n      <div setting-hist-mode parent-widget=\"widget\" deferred=\"::histModeDeferred\" accounting-behaviour=\"pnl\" />\n\n      <div ng-hide=\"widget.isHistoryMode\" class=\"current\">\n        <div class=\"legend\">{{legend}}</div>\n        <div class=\"price\">\n           {{ getCurrentPrice() | mnoCurrency : currency_unit : false }}\n        </div>\n        <div class=\"currency\">{{currency}}</div>\n        <div class=\"price secondary\">\n          {{ getSecondaryPrice() | mnoCurrency : currency_unit : false }}\n          {{ secondaryPerformanceSpan.description }}\n          {{ widget.content.last_time_period.interval }}\n          {{ widget.content.last_time_period.span | lowercase }}\n        </div>\n        <div class=\'show-link\' ng-click=\"switchSpans()\">\n          <a>\n            Show\n            {{ secondaryPerformanceSpan.description }}\n            {{ widget.content.last_time_period.interval }}\n            {{ widget.content.last_time_period.span | lowercase }}\n          </a>\n        </div>\n      </div>\n\n      <div class=\"history chart-container\" ng-show=\"widget.isHistoryMode\">\n        <div impac-chart draw-trigger=\"::drawTrigger.promise\" deferred=\"::chartDeferred\"></div>\n        <div class=\"legend\">{{legend}}</div>\n      </div>\n    </div>\n\n    <div ng-show=\"widget.demoData\" common-data-not-found />\n  </div>\n\n</div>\n");
...
$templateCache.put("widgets/sales-sales-summary.tmpl.html","<div widget-sales-sales-summary>\n\n  <div class=\"edit\" ng-show=\"widget.isEditMode\">\n    <h4 translate>impac.widget.accounts_profit_and_loss.settings.title</h4>\n\n    <div setting-time-period parent-widget=\"widget\" class=\"part\" deferred=\"::timePeriodDeferred\" hist-params=\"widget.metadata.hist_parameters\" />\n    <div setting-tag-filter ng-show=\"filterTagsEnabled == true\" parent-widget=\"widget\" class=\"part\" deferred=\"::tagFilterDeferred\" />\n\n    <div class=\"bottom-buttons\" align=\"right\">\n      <button class=\"btn btn-default\" ng-click=\"initSettings()\" translate>impac.widget.accounts_profit_and_loss.cancel</button>\n      <button class=\"btn btn-warning\" ng-click=\"updateSettings()\" translate>impac.widget.accounts_profit_and_loss.save</button>\n    </div>\n  </div>\n\n  <div ng-hide=\"widget.isEditMode\">\n\n    <div class=\"row\">\n      <div ng-class=\"widget.isExpanded() ? \'col-md-6\' : \'col-md-12\'\">\n\n        <div setting-width parent-widget=\"widget\" min=\"6\" max=\"12\" class=\"settings width\" deferred=\"::widthDeferred\" />\n\n        <div class=\"widget-lines-container\">\n          <!-- Total mode -->\n          <div class=\"row widget-line header\">\n            <div class=\"col-xs-12 text-right\">\n              <span setting-param-selector parent-widget=\"widget\" param=\"amount_displayed\" options=\"amountDisplayedOptions\" selected=\"amountDisplayed\" deferred=\"::paramSelectorDeferred\" no-reload />\n            </div>\n          </div>\n\n          <!-- Tab header -->\n          <div class=\"row widget-line header\">\n            <div class=\"col-xs-7 col-xs-offset-1 text-left sortable-title\" ng-click=\"sort(\'account\')\">\n              Offers\n              <i ng-show=\"sortedColumn == \'account\'\" class=\"fa\" ng-class=\"ascending ? \'fa-sort-alpha-asc\' : \'fa-sort-alpha-desc\'\" />\n            </div>\n            <div class=\"col-xs-4 text-right sortable-title\" ng-click=\"sort(\'total\')\">\n              Total Sales\n              <i ng-show=\"sortedColumn == \'total\'\" class=\"fa\" ng-class=\"ascending ? \'fa-sort-alpha-asc\' : \'fa-sort-alpha-desc\'\" />\n            </div>\n          </div>\n\n          <!-- Groups of statements with their accounts -->\n          <div class=\"row lines-group\" ng-repeat=\"statement in widget.content.summary\" ng-class=\"{profit: statement.name.indexOf(\'profit\')>0}\">\n            <div class=\"col-xs-12\">\n\n              <!-- Statements lines -->\n              <div class=\"row widget-line\" >\n                <div class=\"col-xs-1\" ng-click=\"toggleCollapsed(statement)\">\n                  <i ng-show=\"(statement.accounts && statement.accounts.length)\" class=\"fa\" ng-class=\"isCollapsed(statement) ? \'fa-plus-square-o\' : \'fa-minus-square-o\'\" />\n                </div>\n                <div class=\"col-xs-7\" ng-click=\"toggleSelectedElement(statement)\">\n                  <strong>{{getName(statement) | titleize}}</strong>\n                </div>\n                <div class=\"col-xs-4 text-right\" ng-class=\"getClassColor(getAmount(statement))\" ng-click=\"toggleSelectedElement(statement)\">\n                  <strong>{{getAmount(statement) | mnoCurrency : statement.currency}}</strong>\n                </div>\n\n                <div class=\"selection-tag\" ng-if=\"isSelected(statement)\" ng-style=\"{ \'background-color\': getSelectLineColor(statement) }\"/>\n              </div>\n\n              <!-- Accounts lines -->\n              <div class=\"row\" uib-collapse=\"isCollapsed(statement)\">\n                <div class=\"col-xs-12\">\n                  <div class=\"row widget-line\" ng-click=\"toggleSelectedElement(account, statement.name)\" ng-repeat=\"account in statement.accounts\" >\n                    <div class=\"col-xs-7 col-xs-offset-1\">\n                      {{account.name}}\n                    </div>\n                    <div class=\"col-xs-4 text-right\" ng-class=\"getClassColor(getAmount(account))\">\n                      {{getAmount(account) | mnoCurrency : account.currency}}\n                    </div>\n\n                    <div class=\"selection-tag\" ng-if=\"isSelected(account, statement.name)\" ng-style=\"{ \'background-color\': getSelectLineColor(account, statement.name) }\"/>\n                  </div>\n                </div>\n              </div>\n\n            </div>\n          </div>\n\n          <div class=\"row widget-line header\" ng-show=\"isReportFiltered()\">\n            <div class=\"col-xs-12 text-center\">\n              <strong translate>impac.widget.settings.tag-filter.report_filtered</strong>\n            </div>\n          </div>\n\n        </div>\n\n      </div>\n\n      <div class=\"col-md-6 right-panel text-center\" ng-show=\"widget.isExpanded()\">\n\n        <div ng-show=\"hasElements()\">\n          <h4>{{period_translation}} Sales Totals</h4>\n          <div ng-show=\"selectedElements.length < 2\" class=\"legend\">{{getName(selectedElements[0]) | titleize}}</div>\n\n          <div class=\"chart-container\">\n            <div impac-chart draw-trigger=\"::drawTrigger.promise\" deferred=\"::chartDeferred\"></div>\n          </div>\n\n          <div ng-show=\"selectedElements.length < 2\" class=\"widget-lines-container\">\n\n            <!-- Not mobile -->\n            <div class=\"row\">\n              <span ng-repeat=\"date in dates track by $index\" class=\"hidden-xs\">\n                <!-- Separator every 4 items -->\n                <div ng-if=\"$index % 4 == 0 && $index > 0\" class=\"clearfix dashed\"></div>\n\n                <div class=\"col-sm-3 text-center\">\n                  <!-- Date -->\n                  <div class=\"row widget-line\">\n                    <div class=\"col-sm-12\">\n                      {{date | mnoDate : widget.metadata.hist_parameters.period}}\n                    </div>\n                  </div>\n                  <!-- Amount + currency -->\n                  <div class=\"row widget-line\">\n                    <div class=\"col-sm-12\" ng-class=\"getClassColor(selectedElements[0].totals[$index])\">\n                      {{selectedElements[0].totals[$index] | mnoCurrency : selectedElements[0].currency}}\n                    </div>\n                  </div>\n                </div>\n              </span>\n            </div>\n\n            <!-- Mobile -->\n            <div ng-repeat=\"date in dates track by $index\" class=\"row widget-line visible-xs\">\n              <!-- Date -->\n              <div class=\"col-xs-6\">\n                {{date | mnoDate : widget.metadata.hist_parameters.period}}\n              </div>\n              <!-- Amount + currency -->\n              <div class=\"col-xs-6 text-right\" ng-class=\"getClassColor(selectedElements[0].totals[$index])\">\n                {{selectedElements[0].totals[$index] | mnoCurrency : selectedElements[0].currency}}\n              </div>\n            </div>\n          </div>\n\n          <div ng-hide=\"selectedElements.length < 2\" class=\"widget-lines-container\">\n            <div class=\"row widget-line\" ng-repeat=\"element in selectedElements track by $index\">\n              <div class=\"col-xs-7 text-left\">\n                <i class=\"fa fa-circle\" ng-style=\"{ \'margin\': \'0px 8px\', \'color\': getElementChartColor($index) }\" />\n                {{getName(element) | titleize}}\n              </div>\n              <div class=\"col-xs-5 text-right\">\n                <i ng-class=\"getClassColor(getAmount(element))\">\n                  {{getAmount(element) | mnoCurrency : element.currency}}\n                </i>\n              </div>\n            </div>\n          </div>\n        </div>\n\n        <div ng-hide=\"hasElements()\" class=\"no-element\" translate>\n          impac.widget.accounts_profit_and_loss.no_elements_selected\n        </div>\n      </div>\n\n    </div>\n\n    <div ng-show=\"widget.demoData\" common-data-not-found />\n  </div>\n\n</div>\n");
...
$templateCache.put("widgets-settings/last-time-period.tmpl.html","<div class=\"settings last-time-period\">\n  <h5 translate>Time Period</h5>\n\n  <div class=\"row widget-lines-container\">\n    <div class=\"col-xs-12 widget-line\">\n      <strong translate>Last</strong>\n      <select ng-model=\"selectedInterval\" ng-options=\"interval for interval in intervals\" />\n      <select ng-model=\"selectedTimeSpan\" ng-options=\"timeSpan for timeSpan in timeSpans\" />\n    </div>\n  </div>\n</div>\n");
...
$templateCache.put("widgets-settings/offers.tmpl.html","<div class=\"settings offers\">\n  <h5 translate>Select Offer</h5>\n\n  <div class=\"row widget-lines-container\">\n    <div class=\"col-xs-12 widget-line\">\n      <strong translate>Offer</strong>\n      <select ng-model=\"selectedOffer\" ng-options=\"offer as offer.name for offer in parentWidget.content.offers\" />\n    </div>\n  </div>\n</div>\n");
...
(function () {console.info("Impac! Front-End Library - v1.6.3-opal"); window["impac"] = {"version": "1.6.3-opal"};}).call();
(function() {
...
(function() {
  angular.module('impac.services.bolt-resources', []).service('BoltResources', ["$http", "ImpacMainSvc", function($http, ImpacMainSvc) {
    ...
    authHeaders = function() {
      ...
      if (_.isEmpty(ssoSession)) {
        return {};
      } else {
        return {
          'Authorization': 'Basic ' + btoa(ssoSession)
        };
      }
    };
...
(function() {
  angular.module('impac.services.dashboards', []).service('ImpacDashboardsSvc', ["$q", "$http", "$log", "$timeout", "ImpacMainSvc", "ImpacRoutes", "ImpacTheming", "ImpacDeveloper", "ImpacUtilities", function($q, $http, $log, $timeout, ImpacMainSvc, ImpacRoutes, ImpacTheming, ImpacDeveloper, ImpacUtilities) {
    var _self, fetchWidgetsTemplates, isTemplateAllowed, needConfigurationLoad, setDefaultCurrentDashboard, widgetsTemplatesUrl;
    _self = this;
    this.config = {};
...
(function() {
  ...
  module.controller('WidgetSalesCustomerEngagementCtrl', ["$scope", "$q", "$filter", "ImpacKpisSvc", "ImpacWidgetsSvc", "ImpacAssets", "HighchartsFactory", "BoltResources", function($scope, $q, $filter, ImpacKpisSvc, ImpacWidgetsSvc, ImpacAssets, HighchartsFactory, BoltResources) {
    var onClickBar, onZoom, settingsPromises, todayUTC, w;
    w = $scope.widget;
    $scope.paramSelectorDeferred = $q.defer();
    settingsPromises = [$scope.paramSelectorDeferred.promise];
    $scope.trxList = {
      display: false,
      updated: false
    };
    ...
    $scope.trxList.fetch = function(currentPage) {
      ...
      return BoltResources.index(w.metadata.bolt_path, $scope.trxList.resources, params).then(function(response) {
        $scope.trxList.customers = _.map(response.data.data, function(trx) {
          return angular.merge(trx.attributes, {
            id: trx.id
          });
        });
    ...
    w.initContext = function() {
      ...
      $scope.isDataFound = w.content != null;
      if ($scope.isDataFound) {
        offers = ((w.content.grouped_table != null) && w.content.grouped_table.groups[0]) || [];
        $scope.filterOptions = _.map(offers, function(offer) {
          return {
            label: offer.name,
            value: offer.id
          };
        ...
        return $scope.filter = angular.copy(_.find($scope.filterOptions, function(o) {
          return w.metadata && w.metadata.selected_offer === o.value;
        }) || $scope.filterOptions[0]);
      }
    };
    onClickBar = function(event) {
      var resources, series;
      series = this;
      if (series.name.toLowerCase() === 'number of customers') {
        resources = 'customers';
      }
      if (resources == null) {
        return;
        ...
        return {
          tooltip: {
            ...
            formatter: function() {
              ...
              name = this.series.name;
              date = moment.utc(this.x).format('Do MMM YYYY');
              amount = _.get(this.series.options, 'yAxis') === 0 ? amount = $filter('mnoCurrency')(this.y, currency, false) : this.y;
              return "<strong>" + date + "</strong><br>" + name + ": " + amount;
            }
          },
    ...
    $scope.chartId = function() {
      return "customerEngagementChart-" + w.id;
    };
    return $scope.widgetDeferred.resolve(settingsPromises);
  }]);

  module.directive('widgetSalesCustomerEngagement', function() {
    return {
      restrict: 'A',
...
(function() {
  ...
  module.controller('WidgetSalesOfferPerformanceCtrl', ["$scope", "$timeout", "$q", "ChartFormatterSvc", "$filter", "$translate", function($scope, $timeout, $q, ChartFormatterSvc, $filter, $translate) {
    var settingsPromises, w;
    w = $scope.widget;
    ...
    $scope.histModeDeferred = $q.defer();
    $scope.chartDeferred = $q.defer();
    settingsPromises = [$scope.offersDeferred.promise, $scope.timePeriodDeferred.promise, $scope.histModeDeferred.promise, $scope.chartDeferred.promise];
    w.initContext = function() {
      $scope.isDataFound = (w.content != null) && (w.content.performance != null);
      if ($scope.isDataFound) {
    ...
    $scope.switchSpans = function() {
      ...
      $scope.histParams = $scope.selectedPerformanceSpan.hist_parameters;
      w.metadata.hist_parameters = $scope.histParams;
      return $scope.initSettings() && w.format();
    };
    $scope.getCurrentPrice = function() {
      if ($scope.isDataFound) {
        return $scope.selectedPerformanceSpan.total_period;
      }
    };
    $scope.getSecondaryPrice = function() {
      if ($scope.isDataFound) {
        return $scope.secondaryPerformanceSpan.total_period;
      }
    };
    $scope.getCurrency = function() {
      if ($scope.isDataFound) {
        if ($scope.selectedPerformanceSpan.currency_key != null) {
          return $translate($scope.selectedPerformanceSpan.currency_key).then(function(translation) {
            $scope.currency = translation;
            return $scope.currency_unit = $scope.selectedPerformanceSpan.currency;
          });
        } else {
    ...
    $scope.getLegend = function() {
      if ($scope.isDataFound) {
        if ($scope.selectedPerformanceSpan.legend_key != null) {
          return $translate($scope.selectedPerformanceSpan.legend_key).then(function(translation) {
            return $scope.legend = translation;
          });
        } else {
          return $scope.legend = $scope.selectedPerformanceSpan.legend;
        }
      }
    };
    $scope.drawTrigger = $q.defer();
  ...
  module.directive('widgetSalesOfferPerformance', function() {
    return {
      restrict: 'A',
...
(function() {
  ...
  module.controller('WidgetSalesSalesSummaryCtrl', ["$scope", "$q", "ChartFormatterSvc", "$filter", "ImpacWidgetsSvc", "ImpacUtilities", "$translate", "ImpacTheming", function($scope, $q, ChartFormatterSvc, $filter, ImpacWidgetsSvc, ImpacUtilities, $translate, ImpacTheming) {
    var fetchElement, getIdentifier, getLastAmount, getPeriod, getTotalAmount, h, matchElementToSelectedElement, periodName, selectedElementsSetting, setAmountDisplayed, settingsPromises, sortAccountsBy, sortData, unCollapsedSetting, w;
    w = $scope.widget;
    $scope.timePeriodDeferred = $q.defer();
    $scope.widthDeferred = $q.defer();
    ...
    $scope.paramSelectorDeferred = $q.defer();
    $scope.tagFilterDeferred = $q.defer();
    settingsPromises = [$scope.timePeriodDeferred.promise, $scope.widthDeferred.promise, $scope.chartDeferred.promise, $scope.paramSelectorDeferred.promise, $scope.tagFilterDeferred.promise];
    $scope.ascending = true;
  ...
  module.directive('widgetSalesSalesSummary', function() {
    return {
      restrict: 'A',
...
(function() {
  ...
  module.controller('SettingLastTimePeriodCtrl', ["$scope", "$log", "ImpacDashboardsSvc", function($scope, $log, ImpacDashboardsSvc) {
    var setting, w;
    w = $scope.parentWidget;
    $scope.selectedOffer = {};
    ...
    setting.initialize = function() {
      ...
      return $scope.selectedTimeSpan = w.content.last_time_period.span;
    };
    setting.toMetadata = function() {
      return {
        last_time_period: {
          interval: $scope.selectedInterval,
          span: $scope.selectedTimeSpan
        }
      };
    };
    w.settings.push(setting);
  ...
  module.directive('settingLastTimePeriod', ["$templateCache", function($templateCache) {
    return {
      restrict: 'A',
      scope: {
        parentWidget: '=',
...
(function() {
  ...
  module.controller('SettingOffersCtrl', ["$scope", "$log", "ImpacDashboardsSvc", function($scope, $log, ImpacDashboardsSvc) {
    var setting, w;
    w = $scope.parentWidget;
    $scope.selectedOffer = {};
    setting = {};
    ...
    setting.isInitialized = false;
    setting.initialize = function() {
      return $scope.selectedOffer = _.find(w.content.offers, function(offer) {
        return offer.id === w.content.selected_offer.id;
      });
    };
    setting.toMetadata = function() {
      w.content.selected_offer = $scope.selectedOffer;
      return {
        offer: w.content.selected_offer
      };
    };
    w.settings.push(setting);
    return $scope.deferred.resolve($scope.parentWidget);
  ...
  module.directive('settingOffers', ["$templateCache", function($templateCache) {
    return {
      restrict: 'A',
      scope: {
        parentWidget: '=',
  ...
  module.directive('settingTimePeriod', ["$templateCache", "$q", "$log", "$timeout", "ImpacTheming", "$translate", function($templateCache, $q, $log, $timeout, ImpacTheming, $translate) {
    return {
      ...
      link: function(scope) {
        ...
        scope.periods = [
          {
            label: $translate.instant('impac.widget.settings.time_period.period.daily'),
            plural: 'days',
            value: 'DAILY'
          }, {
            label: $translate.instant('impac.widget.settings.time_period.period.weekly'),
            plural: 'weeks',
            value: 'WEEKLY'
          }, {
            label: $translate.instant('impac.widget.settings.time_period.period.monthly'),
            plural: 'months',
            value: 'MONTHLY'
          }, {
            label: $translate.instant('impac.widget.settings.time_period.period.quarterly'),
            plural: 'quarters',
            value: 'QUARTERLY'
          }, {
            label: $translate.instant('impac.widget.settings.time_period.period.yearly'),
            plural: 'years',
            value: 'YEARLY'
          }
        ];
