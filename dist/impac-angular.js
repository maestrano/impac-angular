...
$templateCache.put("widgets/sales-top-customers.tmpl.html","<div widget-sales-top-customers>\n  <div class=\"edit\" ng-show=\"widget.isEditMode\">\n    <h4>Widget settings</h4>\n\n    <div setting-organizations parent-widget=\"widget\" class=\"part\" deferred=\"::orgDeferred\" />\n    <div setting-dates-picker parent-widget=\"widget\" class=\"part\" from=\"(widget.metadata.hist_parameters.from || defaultFrom)\" to=\"(widget.metadata.hist_parameters.to || defaultTo)\" keep-today=\"widget.metadata.hist_parameters.keep_today\" deferred=\"::datesPickerDeferred\"/>\n\n    <div class=\"bottom-buttons\" align=\"right\">\n      <button class=\"btn btn-default\" ng-click=\"initSettings()\">Cancel</button>\n      <button class=\"btn btn-warning\" ng-click=\"updateSettings()\">Save</button>\n    </div>\n  </div>\n\n  <div ng-hide=\"widget.isEditMode\" class=\"widget-lines-container\">\n\n    <div class=\"row selector\" ng-show=\"(isDataFound==true)\">\n      <div class=\"col-xs-12 text-right\">\n        <a ng-click=\"toggleTransactions()\">{{transactionsCollapsed ? \'Show\' : \'Hide\'}} transactions</a> |\n        <div setting-param-selector parent-widget=\"widget\" param=\"limit_entries\" options=\"limitEntriesOptions\" selected=\"limitEntriesSelected\" class=\"param-selector\" deferred=\"::paramSelectorDeferred\" no-reload/>\n      </div>\n    </div>\n\n    <!-- Header line -->\n    <div class=\"row widget-line header\">\n      <div class=\"col-xs-1\">\n        #\n      </div>\n      <div class=\"col-xs-7\">\n        Customer name\n      </div>\n      <div class=\"col-xs-4 text-right\">\n        Total sales\n      </div>\n    </div>\n\n    <!-- Content lines -->\n    <div class=\"row lines-group\" ng-show=\"(isDataFound==true)\" ng-repeat=\"entity in widget.content.entities | limitTo: limitEntriesSelected.value\">\n      <div class=\"col-xs-12\">\n\n        <div class=\"row widget-line\">\n          <div class=\"col-xs-1\">\n            {{$index + 1}}\n          </div>\n          <div class=\"col-xs-7\">\n            <b>{{entity.name}}</b>\n          </div>\n          <div class=\"col-xs-4 text-right\">\n            <b>{{entity.total_invoiced | mnoCurrency : entity.currency}}</b>\n          </div>\n        </div>\n\n        <div class=\"row widget-line text-right\" collapse=\"transactionsCollapsed\">\n          <div class=\"col-xs-4\">\n            <i>{{entity.invoices.length}} transaction{{entity.invoices.length > 1 ? \'s\' : \'\'}}:</i>\n          </div>\n          <div class=\"col-xs-4\">\n            avg: <i>{{(entity.total_invoiced / entity.invoices.length) | mnoCurrency : entity.currency}}</i>\n          </div>\n          <div class=\"col-xs-4\">\n            last: <i>{{entity.invoices[entity.invoices.length - 1].invoiced | mnoCurrency : entity.currency}}</i>\n          </div>\n        </div>\n\n      </div>\n    </div>\n\n    <!-- Data not found line -->\n    <div class=\"row widget-line\" ng-show=\"(isDataFound==false)\">\n      <div class=\"col-xs-12\">No sales data found for your customers</div>\n    </div>\n\n  </div>\n\n</div>\n");
...
angular.module('impac.services.widgets', []).service('ImpacWidgetsSvc', ["$q", "$http", "$log", "ImpacRoutes", "ImpacMainSvc", "ImpacDashboardsSvc", function($q, $http, $log, ImpacRoutes, ImpacMainSvc, ImpacDashboardsSvc) {
  ...
  this.update = function(widget, opts) {
    ...
    _self.load().then(function(config) {}, !isWidgetInCurrentDashboard(widget.id) ? ($log.info("ImpacWidgetsSvc: trying to update a widget (id: " + widget.id + ") that is not in currentDashboard"), deferred.reject("trying to update a widget (id: " + widget.id + ") that is not in currentDashboard")) : (data = {
      ...
      return angular.extend(widget, success.data);
    }, function(error) {
      angular.merge(widget, opts);
      return $log.warn("ImpacWidgetsSvc: unable to remotely save widget state (id: " + widget.id + ")");
    })["finally"](function() {
      return deferred.resolve(widget);
    })), function(error) {
      $log.error("ImpacWidgetsSvc: error while trying to load the service");
...
module.controller('WidgetSalesNetSalesCtrl', ["$scope", "$q", "ChartFormatterSvc", "$filter", function($scope, $q, ChartFormatterSvc, $filter) {
  ...
  $scope.displayType = angular.copy(_.find($scope.displayOptions, function(o) {
    return o.value === w.metadata.displayType;
  ...
  $scope.timeRange = angular.copy(_.find($scope.timeRangeOptions, function(o) {
    return o.value === w.metadata.timeRange;
  }) || $scope.timeRangeOptions[0]);
  w.initContext = function() {
    return $scope.isDataFound = (w.content != null) && (w.content.sales != null);
  };
  $scope.getCurrency = function() {
    if ($scope.isDataFound) {
      return w.content.currency;
...
module.controller('WidgetSalesNewVsOldCustomersCtrl', ["$scope", "$q", "ChartFormatterSvc", "$filter", function($scope, $q, ChartFormatterSvc, $filter) {
  var settingsPromises, w;
  w = $scope.widget;
  $scope.orgDeferred = $q.defer();
  ...
  w.initContext = function() {
    $scope.isDataFound = (w.content != null) && (w.content.summary != null) && (w.content.summary.customers_count != null) && (w.content.summary.customers_count.total != null) && w.content.summary.customers_count.total > 0;
    $scope.displayOptions = [
      {
        label: 'Customers',
  ...
  $scope.shouldDisplayCurrency = function() {
    if ($scope.isDataFound) {
      return $scope.displayType.value.indexOf('count') < 0;
    }
  };
...
module.directive('widgetSalesNewVsOldCustomers', function() {
  return {
    restrict: 'A',
...
module.controller('WidgetSalesTopCustomersCtrl', ["$scope", "$q", "$filter", "ImpacUtilities", function($scope, $q, $filter, ImpacUtilities) {
  ...
  w.initContext = function() {
    ...
    if ($scope.isDataFound = !_.isEmpty(w.content) && !_.isEmpty(w.content.entities)) {
      ...
      if (!$scope.limitEntriesSelected) {
        return $scope.limitEntriesSelected = angular.copy(_.find($scope.limitEntriesOptions, {
