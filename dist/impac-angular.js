  ...
  module.component('transactionsAdd', {
    ...
    controller: function() {
      ...
      ctrl.isValid = function() {
        return !(angular.isUndefined(ctrl.trx) || ctrl.trx === null) && !_.isEmpty(ctrl.trx.title) && !isNaN(Number(ctrl.trx.amount)) && Number(ctrl.trx.amount) !== 0 && ctrl.trx.contact;
      };
...
(function() {
  ...
  module.component('schedulesAdd', {
    ...
    controller: function() {
      ...
      ctrl.isValid = function() {
        return !_.isEmpty(ctrl.trx.title) && !isNaN(Number(ctrl.trx.amount)) && Number(ctrl.trx.amount) !== 0;
      };
  ...
  module.component('transactionsList', {
    ...
    controller: function() {
      ...
      ctrl.createSchedule = {
        ...
        create: function(resourcesType, trx) {
  ...
  module.component('trendsAdd', {
    ...
    controller: ["$scope", function($scope) {
      ...
      ctrl.updateDate = function() {
        return ctrl.trend.untilDate = ctrl.datePicker.date;
      };
      return ctrl;
    }]
  });
...
(function() {
  ...
  module.component('trendsList', {
    ...
    controller: function() {
      ...
      ctrl.setDatePicker = function(trend) {
        var m;
        m = moment.utc(trend.last_apply_date);
        return trend.datePicker = {
          opened: false,
          date: new Date(m.year(), m.month(), m.date()),
          toggle: function() {
            if (ctrl.editMode) {
...
(function() {
  ...
  module.controller('WidgetAccountsCashProjectionCtrl', ["$scope", "$q", "$filter", "$timeout", "ImpacKpisSvc", "ImpacWidgetsSvc", "ImpacAssets", "HighchartsFactory", "BoltResources", "ImpacMainSvc", function($scope, $q, $filter, $timeout, ImpacKpisSvc, ImpacWidgetsSvc, ImpacAssets, HighchartsFactory, BoltResources, ImpacMainSvc) {
    ...
    $scope.trxList.deleteSchedulableTransactions = function(resourcesType, trx) {
      var trxId;
      ...
      _.remove($scope.trxList.transactions, function(trx) {
        return trx.recurring_parent === trxId;
      });
...
(function() {
  ...
  module.controller('SettingForecastPayrollCtrl', ["$scope", "$log", "ImpacDashboardsSvc", "ImpacMainSvc", "ImpacWidgetsSvc", function($scope, $log, ImpacDashboardsSvc, ImpacMainSvc, ImpacWidgetsSvc) {
    var setting, w;
    w = $scope.parentWidget;
    w.selectedForecastPayroll = false;
    $scope.toggleForecastPayroll = function() {
      return w.selectedForecastPayroll = !w.selectedForecastPayroll;
    };
    ...
    setting.toMetadata = function() {
      return {
        forecast_payroll: w.selectedForecastPayroll
      };
    };
    w.settings.push(setting);
    return $scope.deferred.resolve($scope.parentWidget);
