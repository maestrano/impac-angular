...
(function() {
  angular.module('impac.components.kpi', []).directive('impacKpi', ["$log", "$http", "$compile", "$templateCache", "ImpacKpisSvc", "ImpacTheming", function($log, $http, $compile, $templateCache, ImpacKpisSvc, ImpacTheming) {
    return {
      restrict: 'EA',
      scope: {
        onDelete: '&',
      ...
      link: function(scope, element, attrs) {
        var _compile, customUrl, getCustomTemplate, getTemplate, options, originUrl;
        options = ImpacTheming.get().dhbKpisConfig.kpi;
        customUrl = options.customTmplPath;
        originUrl = 'kpi/kpi.tmpl.html';
        getCustomTemplate = function(templateUrl) {
        ...
        getTemplate = function(templateUrl) {
          return _compile($templateCache.get(templateUrl));
        };
        _compile = function(htmlString) {
          element.html(htmlString).show();
          return $compile(element.contents())(scope);
        ...
        if (customUrl) {
          getCustomTemplate(customUrl);
        } else {
          getTemplate(originUrl);
        }
        return null;
      }
    };
...
(function() {
  angular.module('impac.components.kpis-bar', []).directive('kpisBar', ["$log", "$http", "$compile", "$templateCache", "ImpacKpisSvc", "ImpacTheming", function($log, $http, $compile, $templateCache, ImpacKpisSvc, ImpacTheming) {
    return {
      restrict: 'E',
      scope: {
        kpis: '='
