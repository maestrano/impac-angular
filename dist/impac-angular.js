...
(function () {
'use strict';
angular.module('impac.components.chart', []).directive('impacChart', ["$templateCache", "$compile", "$timeout", "$log", "$q", function($templateCache, $compile, $timeout, $log, $q) {
  return {
    restrict: 'A',
    scope: {
      drawTrigger: '=',
