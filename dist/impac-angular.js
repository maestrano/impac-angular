    ...
    controller: function() {
      ...
      ctrl.calculateTotals = function() {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          results.push(ctrl.formatDate(trx));
        }
        return results;
      };
...
(function() {
  ...
  module.component('trendsAdd', {
    ...
    controller: ["$scope", function($scope) {
      ...
      ctrl.isValid = function() {
        return !_.isEmpty(ctrl.trend.name) && ctrl.trend.rate > 0 && ((ctrl.trend.untilDate != null) || ctrl.trend.period === "Once") && ctrl.trend.startDate < ctrl.trend.untilDate;
      };
