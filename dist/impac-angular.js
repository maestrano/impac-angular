  ...
  return {
    ...
    link: function(scope, element, attrs) {
      ...
      scope.getOffset = function() {
        var hours, minutes, offset, offsetArray, timezone;
        ...
        return offset = offsetArray.join('');
      };
