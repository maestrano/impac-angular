...
(function() {
  angular.module('impac.services.date-formatter', []).service('ImpacDateFormatter', ["$log", "$locale", "ImpacTheming", "ImpacUtilities", function($log, $locale, ImpacTheming, ImpacUtilities) {
