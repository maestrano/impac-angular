...
angular.module('impac.services.routes', []).provider('ImpacRoutes', function() {
  ...
  _$get = function() {
    ...
    service.syncAppsPath = function(uid) {
      return (defaults.syncAppsBasePath.replace(':uid', uid)) + "/sync_apps";
    };
    service.syncProgressPath = (function(_this) {
      return function(uid) {
        return (defaults.syncAppsBasePath.replace(':uid', uid)) + "/sync_apps_progress";
      };
    })(this);
    return service;
  };
  ...
  return {
    ...
    link: function(scope, element, attrs) {
      ...
      ImpacMainSvc.load(true).then(function(config) {
        ...
        scope.syncingPoller = poller.get(ImpacRoutes.syncProgressPath(scope.orgUID), {
          delay: 5000,
          smart: true
        });
      ...
      return scope.synchronize = function() {
        ...
        scope.syncingApps = true;
        return $http.put(ImpacRoutes.syncAppsPath(scope.orgUID)).then(function(success) {
