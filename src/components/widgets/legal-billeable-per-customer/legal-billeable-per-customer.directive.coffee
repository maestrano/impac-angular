...
#
module = angular.module('impac.components.widgets.legal-billeable-per-customer', [])
module.controller('WidgetLegalBilleablePerCustomerCtrl', ($scope, $q) ->
...
module.directive('widgetLegalBilleablePerCustomer', ->
  return {
    restrict: 'A',
    controller: 'WidgetLegalBilleablePerCustomerCtrl'
  }
)
