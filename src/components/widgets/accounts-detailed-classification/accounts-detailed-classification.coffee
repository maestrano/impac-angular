module = angular.module('impac.components.widgets.accounts-detailed-classification', [])
module.controller('WidgetAccountsDetailedClassificationCtrl', ($scope, $q, ImpacWidgetsSvc) ->
...
module.directive('widgetAccountsDetailedClassification', ->
  return {
    restrict: 'A',
    controller: 'WidgetAccountsDetailedClassificationCtrl'
  }
)
